    ...
    create table procommerce.tb_category (
        id bigint generated by default as identity,
        name varchar(255),
        primary key (id)
    );

    create table procommerce.tb_order (
    ...
    create table procommerce.tb_order_item (
        price float(53),
        quantity integer,
    ...
    create table procommerce.tb_payment (
        moment TIMESTAMP WITHOUT TIME ZONE,
        order_id bigint not null,
        primary key (order_id)
    );

    create table procommerce.tb_product (
        price float(53),
        id bigint generated by default as identity,
        description TEXT,
        img_url varchar(255),
    ...
    create table procommerce.tb_product_category (
        category_id bigint not null,
        product_id bigint not null,
        primary key (category_id, product_id)
    );

    create table procommerce.tb_role (
        id bigint generated by default as identity,
        authority varchar(255),
        primary key (id)
    );

    create table procommerce.tb_user (
        birth_date date,
        id bigint generated by default as identity,
    ...
    create table procommerce.tb_user_role (
        role_id bigint not null,
        user_id bigint not null,
        primary key (role_id, user_id)
    );

    alter table if exists procommerce.tb_order 
       add constraint FKi0x0rv7d65vsceuy33km9567n 
       foreign key (client_id) 
       references procommerce.tb_user;

    alter table if exists procommerce.tb_order_item 
       add constraint FK4h5xid5qehset7qwe5l9c997x 
       foreign key (product_id) 
       references procommerce.tb_product;

    alter table if exists procommerce.tb_order_item 
       add constraint FKgeobgl2xu916he8vhljktwxnx 
       foreign key (order_id) 
       references procommerce.tb_order;

    alter table if exists procommerce.tb_payment 
       add constraint FKokaf4il2cwit4h780c25dv04r 
       foreign key (order_id) 
       references procommerce.tb_order;

    alter table if exists procommerce.tb_product_category 
       add constraint FK5r4sbavb4nkd9xpl0f095qs2a 
       foreign key (category_id) 
       references procommerce.tb_category;
    ...
    alter table if exists procommerce.tb_user_role 
       add constraint FKea2ootw6b6bb0xt3ptl28bymv 
       foreign key (role_id) 
       references procommerce.tb_role;
...
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (1, 1);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (2, 2);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (2, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (3, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (4, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (5, 1);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (6, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (7, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (8, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (9, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (10, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (11, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (12, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (13, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (14, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (15, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (16, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (17, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (18, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (19, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (20, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (21, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (22, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (23, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (24, 3);
INSERT INTO procommerce.tb_product_category (product_id, category_id) VALUES (25, 3);

INSERT INTO procommerce.tb_user (name, email, phone, password, birth_date) VALUES ('Maria Brown', 'maria@gmail.com', '988888888', '$2a$10$N7SkKCa3r17ga.i.dF9iy.BFUBL2n3b6Z1CWSZWi/qy7ABq/E6VpO', '2001-07-25');
INSERT INTO procommerce.tb_user (name, email, phone, password, birth_date) VALUES ('Alex Green', 'alex@gmail.com', '977777777', '$2a$10$N7SkKCa3r17ga.i.dF9iy.BFUBL2n3b6Z1CWSZWi/qy7ABq/E6VpO', '1987-12-13');

INSERT INTO procommerce.tb_role (authority) VALUES ('ROLE_CLIENT');
INSERT INTO procommerce.tb_role (authority) VALUES ('ROLE_ADMIN');
INSERT INTO procommerce.tb_user_role (user_id, role_id) VALUES (1, 1);
INSERT INTO procommerce.tb_user_role (user_id, role_id) VALUES (2, 1);
INSERT INTO procommerce.tb_user_role (user_id, role_id) VALUES (2, 2);

INSERT INTO procommerce.tb_order (moment, status, client_id) VALUES (TIMESTAMP WITH TIME ZONE '2022-07-25T13:00:00Z', 1, 1);
INSERT INTO procommerce.tb_order (moment, status, client_id) VALUES (TIMESTAMP WITH TIME ZONE '2022-07-29T15:50:00Z', 3, 2);
INSERT INTO procommerce.tb_order (moment, status, client_id) VALUES (TIMESTAMP WITH TIME ZONE '2022-08-03T14:20:00Z', 0, 1);

INSERT INTO procommerce.tb_order_item (order_id, product_id, quantity, price) VALUES (1, 1, 2, 90.5);
INSERT INTO procommerce.tb_order_item (order_id, product_id, quantity, price) VALUES (1, 3, 1, 1250.0);
INSERT INTO procommerce.tb_order_item (order_id, product_id, quantity, price) VALUES (2, 3, 1, 1250.0);
INSERT INTO procommerce.tb_order_item (order_id, product_id, quantity, price) VALUES (3, 1, 1, 90.5);

INSERT INTO procommerce.tb_payment (order_id, moment) VALUES (1, TIMESTAMP WITH TIME ZONE '2022-07-25T15:00:00Z');
INSERT INTO procommerce.tb_payment (order_id, moment) VALUES (2, TIMESTAMP WITH TIME ZONE '2022-07-30T11:00:00Z');
